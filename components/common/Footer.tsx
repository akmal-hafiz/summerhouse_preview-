...
export default function Footer() {
  return (
    <footer className="bg-[#F5F3F1] w-full pt-28 pb-16 md:pt-36 md:pb-20 lg:pt-48 lg:pb-24">
      
      <div className="w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-24">
        
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-20 lg:gap-32 pb-24 lg:pb-32 border-b border-black/5">
          ...
          <div className="lg:col-span-8 grid grid-cols-2 md:grid-cols-4 gap-14 md:gap-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-8 pt-12 lg:pt-16">
          <span
